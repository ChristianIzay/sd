...
<div class="card shadow mb-4">
                    <div class="card-body">
{!! Form::open(array('route' => 'promotions.store','method'=>'POST')) !!}
<div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <form>
                                        <select name="Cycle[]" class="form-control" multiple>

                                                <option value="{{ __('Maternelle') }}">{{ __('Maternelle') }}</option>
                                                <option value="{{ __('Primaire') }}">{{ __('Primaire') }}</option>
                                                <option value="{{ __('Humanite') }}">{{ __('Humanite') }}</option>
